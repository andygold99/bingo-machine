...
EntityBox2dBall = ig.Box2DEntity.extend({
    ...
    init: function( x, y, settings ) {
        ...
        //this.addAnim( 'idle', 0.1, [0] ); // Make ball invisible, so only the body is visible now in box2d debug
    ...
    update: function() {
        ...
        if (this.pos.y < 800) {
            this.ballPosRef.update({x: this.pos.x, y: this.pos.y}); // Update firebase with ball position
        }

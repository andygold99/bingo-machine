...
EntityShooter = ig.Entity.extend({
    ...
    callBall: function() {
        ...
        // Launch box2d ball
        var b2d = ig.game.spawnEntity(EntityBox2dBall, x - this.size.x / 2 + - 49, y - this.size.y / 2);
        
        // Launch entity ball
        var b = ig.game.spawnEntity(EntityBall, x - this.size.x / 2 + - 49, y - this.size.y / 2);
        // b.pos.x = x - b.size.x/2 + - 49;
        // b.pos.y = y - b.size.y/2;
        b2d.body.ApplyImpulse( new Box2D.Common.Math.b2Vec2(cos * b2d.speed,sin * b2d.speed), b2d.body.GetPosition() );
        // b.vel.x = cos * b.speed;
        // b.vel.y = sin * b.speed;
